...
public class UI extends Application {
    ...
    public static final String styleLabelMicOff = String.format(
    ...
    public static final String styleButtonDefault = String.format(
            "-fx-background-color: %s; " +
    ...
    public void start(Stage primaryStage) {
        ...
        button.setStyle(styleButtonDefault);
        ...
        button.setOnMouseExited(e -> {
            if (!isRecording) {
                button.setStyle(styleButtonDefault); // Default style if not recording
            }
        });

        // Load the conversation log
        if (initialRun == 1) {
            System.out.println("intialRun: " + initialRun);
            Task<String> task =
        ...
        button.setOnAction(e -> {
            ...
            if (isRecording) {
                ...
                task.setOnFailed(event -> {
                    ...
                    labelMic.setText("Error running Python script.");
                });
